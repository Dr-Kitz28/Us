// Research-backed recommendation engine module
// Extracted from route to allow proper Next.js route exports and test imports
...
export interface UserCompatibilityScore {
  userId: string
